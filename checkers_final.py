...
class Board:
    ...
    def evaluationFunction(self, board, my_checkers, my_kings, oponents_checkers, opponents_kings): # checker is worth 1 point, king is worth 3 points
    ...
    def alphaBeta(self, board, currentDepth, bestMove):
        ...
        if self.terminalState(board) or currentDepth <= 0:
            return (board, self.evaluationFunction(board, self.whiteList, self.whiteKings, self.blackList, self.blackKings))
...
def main():
    ...
    while b.terminalState(boardstate) == False:
        ...
        print("Your score is:")
        print(b.evaluationFunction(boardstate, b.whiteList, b.whiteKings, b.blackList, b.blackKings))
